<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminAddOffer.aspx.cs" Inherits="capstone.adminAddOffer" %>
                    ...
                    <div class="container  p-4 m-4 border-1" style="height:800px;">
                        <div class="row">
                            ...
                            <div class="col-6 ">
                                ...
                                <label class="display-4">Add An Offer</label>
                                <br />
                                <br />
                                <br />
                                <div class="form-outline mb-4">
                                    <input runat="server" id="name" class="form-control" required />
                                    <label class="form-label h5" for="form2Example1">Offer Name</label>
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    <input runat="server" id="Discount" type="number" class="form-control" required />
                                    <label class="form-label h5" for="form2Example1">Discount Percent</label>
                                </div>

                                <div class="form-outline mb-4">
                                    <input runat="server" id="expiry" type="date" class="form-control" required />
                                    <label class="form-label h5" for="offer">expiring date</label><br />
