<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminDeleteProd.aspx.cs" Inherits="capstone.adminDeleteProd" %>
        ...
        <div>
             <div class="wrapper">
                ...
                <nav id="sidebar"  >
                    ...
                    <div  class="card shadow w-100 m-2 cont">
                    <div class="container  p-4 m-4 border-1" style="height:800px;">
                        <div class="row">
                            ...
                            <div class="col-6 ">
                                ...
                                <label class="display-4">Delete a Product</label>
                                <br />
                                <br />
                                <label class="form-label h5" for="form2Example1">Enter product ID</label>
                                
                                <input runat="server" id="prodID" class="form-control" type="number" required />
                                <br />
                                <asp:Button ID="Button1" runat="server" Text="view product" class="btn btn-primary btn-block mb-4"  OnClick="Button1_Click1"  />
                               
                                <br />

                                <br />
                                <asp:GridView ID="selectedProd" runat="server" CssClass="p-3 m-3 table table-striped-columns table-bordered table-secondary"></asp:GridView>
                                <br />
                                <br />
                                <asp:Button runat="server" OnClick="delete" OnClientClick="if(!confirm('Confirm delete?')) return false;"  Text="Delete" class="btn btn-primary btn-block mb-4"></asp:Button>
                                <br />
                                                                <br />

                                <asp:Label runat="server" class="form-label  text-success" ID="deleteMsg"></asp:Label>
                                <br />
                                <br />
                            </div>
                        </div>
