<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminRemoveOffer.aspx.cs" Inherits="capstone.adminRemoveOffer" %>
                    ...
                    <div class="container  p-4 m-4 border-1" style="height:800px;">
                        <div class="row">
                            ...
                            <div class="col-6 ">
                                ...
                                <label class="display-4">Remove an Offer</label>
                                <br />
                                <br />
                                <label class="form-label h5" for="form2Example1">Enter Offer ID</label>
                                
                                <input runat="server" id="offerID" class="form-control" type="number" required />
                                <br />
                                <asp:Button ID="Button1" runat="server" Text="view Offer" class="btn btn-primary btn-block mb-4"  OnClick="Button1_Click1"  />
                               
                                <br />

                                <br />
                                <asp:GridView ID="selectedOffer" runat="server" CssClass="p-3 m-3 table table-striped-columns table-bordered table-secondary"></asp:GridView>
                                <br />
                                <br />
