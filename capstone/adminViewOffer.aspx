<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminViewOffer.aspx.cs" Inherits="capstone.adminViewOffer" %>
                    ...
                    <div class="container  p-4 m-4 border-1" style="height:800px;">
                        <div class="row">
                            ...
                            <div class="col-6 ">
                                ...
                                <label class="display-4">Offers</label>
                                <br />
                                <br />

                                <asp:GridView ID="offerss" runat="server" CssClass="p-3 m-3 table table-striped-columns table-bordered table-secondary"></asp:GridView>
                                <br />
                                <br />
                            </div>
                        </div>
