<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="capstone.Products" %>
    ...
    <form id="form1" runat="server">
        ...
        <!-- Navbar -->
            ...
            <div class="container-md m-auto p-3 ">
                ...
                <h4 class="display-6">Featured Products
                                ...
                                <asp:LinkButton Style="text-decoration: none !important;" CommandArgument='<%#Eval("[id]")%>' runat="server" OnClick="goToDetails">
                                    <div class="card  shadow p-3 mb-5 bg-white rounded" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <br />
                                            <asp:LinkButton class="btn btn-primary fa"  CommandArgument='<%#Eval("[id]")%>' OnClick="addToCart" runat="server"  Text='Add To Cart' />
                                        </div>
                                    </div>
                                </asp:LinkButton>
                            </div>
