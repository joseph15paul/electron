<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminViewProducts.aspx.cs" Inherits="capstone.adminViewProducts" %>
                    ...
                    <div class="container  p-4 m-4 border-1" >
                        <div class="row">
                            ...
                            <div class="col-6 ">
                                ...
                                <label class="display-4">Products</label>
                                <br />
                                <br />

                                <asp:GridView ID="Products" runat="server" CssClass="p-3 m-3 table table-striped-columns table-bordered table-secondary"></asp:GridView>
                                <br />
                                <br />
                            </div>
                        </div>
